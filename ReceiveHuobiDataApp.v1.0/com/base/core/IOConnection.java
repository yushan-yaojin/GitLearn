    ...
    private class HearbeatTimeoutTask extends TimerTask {
        ...
        public void run() {
            error(new SocketIOException(
                    "Timeout Error. No heartbeat from server within life time of the socket. closing.", lastException));
        }
    }
        ...
        case IOMessage.TYPE_ACK:
            ...
            if (data.length == 2) {
                try {
                    ...
                    logger.error("Received malformated Acknowledge! This is potentially filling up the acknowledges!");
                } catch (JSONException e) {
